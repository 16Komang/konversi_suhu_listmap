...
import 'package:konversi_suhu_listmap/widgets/DaftarSuhu.dart';
import 'package:konversi_suhu_listmap/widgets/HistoryKonversi.dart';
import 'package:konversi_suhu_listmap/widgets/InputSuhu.dart';
void main() {
  runApp(MyApp());
}
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Center(child: Text('Komang|2041720225')),
        ),
        body: Container(
